...
In this ocasion I would like to show an app which is a mimetic of Flybondi' site. It was builded using React.js, Charkra-UI and React-Router to navigate, filter and narrow the search of round trip flights. The data was getted (fetched) by mocking a server, and the app showed it in differents pages containing cities (origin) and alternatives destination. The app allow the navigate between pages and also you can choose your fligth on basis of number of passengers and price. I hope that you enjoy it!!
